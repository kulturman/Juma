...
export class updateTorrentTable1654472168610 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`torrents\` ADD \`torrent_name\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`torrents\` DROP COLUMN \`torrent_name\``);
    }
